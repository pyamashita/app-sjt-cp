...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <span class="ml-2 text-gray-600 font-medium">スケジュール追加</span>
                </div>
    ...
    <main class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 sm:px-0">
            <!-- ヘッダー -->
            <div class="mb-8">
                <h2 class="text-3xl font-bold text-gray-900">スケジュール追加</h2>
                <p class="text-gray-600 mt-2">{{ $competitionDay->day_name }}（{{ $competitionDay->formatted_date }}）のスケジュールを追加してください。</p>
            </div>
