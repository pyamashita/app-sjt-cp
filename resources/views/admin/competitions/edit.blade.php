...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <span class="ml-2 text-gray-600 font-medium">{{ $competition->name }} 編集</span>
                </div>
    ...
    <main class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 sm:px-0">
            <!-- ヘッダー -->
            <div class="mb-8">
                <h2 class="text-3xl font-bold text-gray-900">大会編集</h2>
                <p class="text-gray-600 mt-2">{{ $competition->name }} の情報を編集してください。</p>
            </div>
                    ...
                    <div id="app">
                        <competition-form
                            ...
                            :competition="{{ json_encode([
                                ...
                                'chief_judge_id' => $competition->chiefJudge() ? $competition->chiefJudge()->id : null,
                                'committee_member_ids' => $competition->judges()->pluck('id')->toArray()
                            ]) }}"
