...
<head>
    ...
    <title>選手編集 - SkillJapan Tools</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-gray-600 font-medium">選手編集</span>
                </div>
    ...
    <main class="max-w-3xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 sm:px-0">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">選手編集</h2>
                    <p class="text-gray-600 mt-1">{{ $player->name }} の情報を編集します</p>
                </div>
                        ...
                        <div>
                            ...
                            <select id="prefecture" 
                                ...
                                @foreach($prefectures as $prefecture)
                                    <option value="{{ $prefecture }}" {{ old('prefecture', $player->prefecture) === $prefecture ? 'selected' : '' }}>
                                        {{ $prefecture }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select id="gender" 
                                ...
                                @foreach($genders as $key => $label)
                                    <option value="{{ $key }}" {{ old('gender', $player->gender) === $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
