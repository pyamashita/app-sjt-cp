...
@section('content')
    ...
    <x-data-table
        ...
        :rows="$tableRows"
        :actions="[
            ['type' => 'link', 'label' => '詳細', 'url' => '/sjt-cp-admin/resources/:id', 'color' => 'blue'],
            ['type' => 'link', 'label' => '編集', 'url' => '/sjt-cp-admin/resources/:id/edit', 'color' => 'green'],
            ['type' => 'form', 'label' => '削除', 'url' => '/sjt-cp-admin/resources/:id', 'method' => 'DELETE', 'color' => 'red', 'confirm' => 'このリソースを削除してもよろしいですか？関連するファイルも削除されます。']
        ]"
