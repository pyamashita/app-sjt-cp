        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="text-center">
                ...
                @if($hasPlayerManagedCollections)
                    <div class="mt-4">
                        <form method="GET" action="{{ route('guide.public', $guidePage->competition_id) }}" class="flex items-center justify-center space-x-2">
                            <label for="player_id" class="text-sm font-medium text-gray-700">選手選択:</label>
